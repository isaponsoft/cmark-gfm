...
typedef enum {
  ...
  CMARK_NODE_TABLE          = CMARK_NODE_TYPE_BLOCK | 0x000c,
  CMARK_NODE_TABLE_ROW      = CMARK_NODE_TYPE_BLOCK | 0x000d,
  CMARK_NODE_TABLE_CELL     = CMARK_NODE_TYPE_BLOCK | 0x000e,
  ...
  CMARK_NODE_STRIKETHROUGH = CMARK_NODE_TYPE_INLINE | 0x000c,
} cmark_node_type;
